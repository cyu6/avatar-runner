...
class Fire extends Group {
   ...
   update(timeStamp) {
      ...
      if (timeStamp !== undefined) {
         this.state.material.uniforms.time.value = timeStamp * 2.9;
      }
   
      this.state.material.uniforms.invModelMatrix.value = invModelMatrix;
   
      this.state.material.uniforms.scale.value = this.scale;
